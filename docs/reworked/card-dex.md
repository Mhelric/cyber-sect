## **Rookie Suite: The Blue Team Essentials**
**Theme:** Basic Tools. Reliable, low complexity.  
**Deck Size:** 15 Cards (Fixed Blueprint)
...
* **CyberDex:** "The act of terminating a running process to free up system resources." [System Admin Fundamentals]

**8. WhoIs Lookup**
* **Category:** [Specialized] (Investigation)
* **Rarity:** Common — *Upgrade: 3 Copies*
* **Cost:** 1 RAM
* **Base Effect:** **Remove "Unattackable"** status from target and apply **Vulnerable** (Player deals added damage).
* **Upgrade Path:**
...
| Card Name | Qty in Rookie Suite | Rarity | Upgrade Cost |
| :--- | :--- | :--- | :--- |
