...
* **Upgrade Path:** v2.0 (Shield + 5 dmg) | v3.0 (Shield + 10 dmg)
...
### **14. Brute Force**
* **Category:** [Specialized] (Crypto) | **Rarity:** Uncommon | **Cost:** 2 RAM
* **Base Effect:** Deal **27 Damage**. Lose **8 HP**.
* **Upgrade Path:** v2.0 (32 Dmg)
...
* **Base Effect:** Gain **12 Shield**. Apply **"Integrity Lock"** for **2 turns**.
* **Special:** Prevents cards from being **Locked or Discarded** by enemies.
* **Upgrade Path:** v2.0 (15 Shield) | v3.0 (18 Shield)

### **27. Cold Storage**
* **Category:** [Specialized] (Crypto) | **Rarity:** Rare | **Cost:** 2 RAM
* **Base Effect:** Gain **20 Shield**.
* **Upgrade Path:** Read-Only (No Upgrades)

### **28. Load Balancer**
* **Category:** [General] | **Rarity:** Rare | **Cost:** 3 RAM
* **Base Effect:** Gain **20 Shield**. Gain **+1 RAM** at the start of your turn for **5 turns**.
* **Upgrade Path:** Read-Only (No Upgrades)
