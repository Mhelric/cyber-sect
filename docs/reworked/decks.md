...
### **Summary Table for Rookie Suite**
...
## **Verification Suite (Chapter 2 Deck)**
**Theme:** Identity Verification & Psychological Defense.  
**Deck Size:** 20 Cards (10 Unique Types × 2 Copies Each)
...
* **Rarity:** Starter (Common) — *Upgrade: 3 Copies*
* **Cost:** 1 RAM
* **Base Effect:** Deal **6 Damage**. (Useful for testing Phishing Links).
* **Upgrade Path:** * **v2.0:** Deal 9 Damage.
    * **v3.0:** Deal 12 Damage.
* **CyberDex:** "A utility used to test the reachability of a host on an Internet Protocol (IP) network." [RFC 792]
...
* **Rarity:** Common — *Upgrade: 3 Copies*
* **Cost:** 1 RAM
* **Base Effect:** Gain **5 Shield**. If Social: **Negate all actions** (Damage/Heal/Debuffs/Locks) from the target this turn.
* **Upgrade Path:**
    * **v2.0:** Gain 8 Shield.
    * **v3.0:** Gain 11 Shield.
...
* **Rarity:** Common — *Upgrade: 3 Copies*
* **Cost:** 2 RAM
* **Base Effect:** Gain **10 Shield**. If Social: **Reflect** all damage back at the attacker.
* **Upgrade Path:**
    * **v2.0:** Gain 15 Shield.
    * **v3.0:** Gain 20 Shield.
...
* **Rarity:** Common — *Upgrade: 3 Copies*
* **Cost:** 0 RAM
* **Base Effect:** Gain **1 Energy**. If Social: **Remove "Unattackable"** and apply **2 Vulnerable** to all enemies.
* **Upgrade Path:**
...
* **Rarity:** Common — *Upgrade: 3 Copies*
* **Cost:** 1 RAM
* **Base Effect:** **Remove "Unattackable"** status. If Social: **Stun** the target.
* **Upgrade Path:**
    * **v2.0:** Apply 2 Weakness.
    * **v3.0:** Apply 2 Weakness & Draw 1.
* **CyberDex:** "A query protocol used for accessing databases that store the registered users of an Internet resource." [RFC 3912]
...
### **Summary Table for Verification Suite**

| Card Name | Qty in Deck | Card Type | Rarity | Upgrade Rule |
| :--- | :--- | :--- | :--- | :--- |
| **Ping Command** | 2 | Attack | Common | 3 Copies |
| **Spam Filter** | 2 | Attack | Uncommon | 2 Copies |
| **Exploit Kit** | 2 | Attack | Common | 3 Copies |
| **MFA** | 2 | Defense | Common | 3 Copies |
| **Data Encryption** | 2 | Defense | Common | 3 Copies |
| **Patch Update** | 2 | Defense | Common | 3 Copies |
| **Sandbox Environment** | 2 | Defense | Common | 3 Copies |
| **Awareness Training** | 2 | Utility | Common | 3 Copies |
| **WhoIs Lookup** | 2 | Utility | Common | 3 Copies |
